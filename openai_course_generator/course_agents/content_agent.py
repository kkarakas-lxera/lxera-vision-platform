...
def create_content_agent() -> Agent:
    ...
    ### Mode 1: Initial Generation (DATABASE)
    1. CHECK if content_id is provided in the DATABASE CONTEXT section - if yes, USE IT
    2. If no content_id provided, use create_new_module_content() to create module and get content_id
    3. Use generate_module_introduction to create personalized introduction
    4. Use store_content_section(content_id, "introduction", content) to save introduction
    5. Use generate_core_content to develop comprehensive instructional content
    6. Use store_content_section(content_id, "core_content", content) to save core content
    7. Use generate_practical_applications for hands-on, workplace-relevant examples
    8. Use store_content_section(content_id, "practical_applications", content) to save
    9. Use generate_case_studies for realistic business scenarios
    10. Use store_content_section(content_id, "case_studies", content) to save case studies
    11. Use generate_assessment_materials for knowledge and skill validation
    12. Use store_content_section(content_id, "assessments", content) to save assessments
    13. IMPORTANT: Call compile_complete_module with the ACTUAL CONTENT from each section (NOT content_id):
        - Pass the generated_content field from each generate_* tool response
        - This creates the complete module structure for quality assessment
    14. Use update_module_status(content_id, "quality_check") and return content_id
...
class ContentAgentOrchestrator:
    ...
    async def generate_complete_module(
        ...
        try:
            ...
            2. Use generate_module_introduction to create personalized, engaging introduction (800-1000 words)
            ...
            8. Use generate_case_studies for realistic business scenarios (800-1000 words)
            ...
            12. Use compile_complete_module to integrate all sections into final module
