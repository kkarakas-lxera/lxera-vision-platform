# Deploy Edge Functions via Supabase Web Editor

## Two Functions to Deploy:

### 1. Position Description Generator

1. Go to your Supabase Dashboard: https://supabase.com/dashboard/project/xwfweumeryrgbguwrocr
2. Navigate to **Edge Functions** in the sidebar
3. Click **Create a new function**
4. Name it: `generate-position-description`
5. Replace the default code with the **Position Description Function Code** below
6. Click **Deploy**

### 2. Skills & Responsibilities Suggester

1. Click **Create a new function**
2. Name it: `suggest-position-skills-enhanced`
3. Replace the default code with the **Skills Function Code** below
4. Click **Deploy**

## Position Description Function Code:
