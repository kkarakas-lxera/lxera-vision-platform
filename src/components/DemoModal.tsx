...
const DemoModal = ({ isOpen, onClose }: DemoModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl w-[90vw] max-h-[90vh] overflow-y-auto bg-white rounded-[2rem] border-0 shadow-2xl p-0">
        <DialogHeader className="rounded-t-[2rem] px-4 pt-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 px-4 pb-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <Input
                ...
                required
                className={`border-0 bg-gray-100 rounded-xl h-9 px-3 text-sm transition-all duration-200 ${
                  errors.firstName 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <Input
                ...
                onChange={handleInputChange}
                className="border-0 bg-gray-100 rounded-xl h-9 px-3 text-sm focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <Select value={formData.numberOfEmployees} onValueChange={(value) => handleSelectChange('numberOfEmployees', value)}>
                <SelectTrigger className="border-0 bg-gray-100 rounded-xl h-9 px-3 text-sm focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200">
                  <SelectValue placeholder="Select size" />
                </SelectTrigger>
                <SelectContent className="bg-white border border-gray-200 rounded-xl shadow-xl z-50 max-h-48 overflow-y-auto">
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={handleInputChange}
              className="border-0 bg-gray-100 min-h-[60px] rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200 resize-none"
            />
          </div>
          ...
          <Button 
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-semibold text-sm shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
          >
            {isSubmitting ? (
              <>
