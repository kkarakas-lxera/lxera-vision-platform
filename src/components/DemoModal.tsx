...
const DemoModal = ({ isOpen, onClose }: DemoModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl w-[95vw] max-h-[95vh] overflow-y-auto bg-white rounded-[1.5rem] sm:rounded-[2.5rem] border-0 shadow-2xl p-0">
        <DialogHeader className="rounded-t-[1.5rem] sm:rounded-t-[2.5rem] px-4 sm:px-6 pt-4 sm:pt-6">
          ...
          <DialogTitle className="text-lg sm:text-xl font-semibold text-left text-business-black">
            Get a demo
          </DialogTitle>
        </DialogHeader>
        
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 px-4 sm:px-6 pb-4 sm:pb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
              <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium">First name *</label>
              <Input
                name="firstName"
                ...
                required
                className={`border-0 bg-gray-100 rounded-[1rem] sm:rounded-[1.5rem] h-10 sm:h-12 px-3 sm:px-4 text-sm transition-all duration-200 ${
                  errors.firstName 
            ...
            <div>
              <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium">Last name *</label>
              <Input
                name="lastName"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
              <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium">Work email *</label>
              <Input
                name="workEmail"
                type="email"
            ...
            <div>
              <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium">Company name *</label>
              <Input
                name="companyName"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
              <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium">Job title</label>
              <Input
                name="jobTitle"
                placeholder="Your role"
                value={formData.jobTitle}
                onChange={handleInputChange}
                className="border-0 bg-gray-100 rounded-[1rem] sm:rounded-[1.5rem] h-10 sm:h-12 px-3 sm:px-4 text-sm focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200"
              />
            </div>
            <div>
              <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium">Phone number</label>
              <Input
                name="phoneNumber"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
              <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium"># of employees</label>
              <Select value={formData.numberOfEmployees} onValueChange={(value) => handleSelectChange('numberOfEmployees', value)}>
                <SelectTrigger className="border-0 bg-gray-100 rounded-[1rem] sm:rounded-[1.5rem] h-10 sm:h-12 px-3 sm:px-4 text-sm focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200">
                  <SelectValue placeholder="Select size" />
                </SelectTrigger>
                <SelectContent className="bg-white border border-gray-200 rounded-[1rem] sm:rounded-[1.5rem] shadow-xl z-50 max-h-64 overflow-y-auto">
            ...
            <div>
              <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium">Country</label>
          ...
          <div>
            <label className="text-sm text-gray-600 mb-1.5 sm:mb-2 block font-medium">How can we help you?</label>
            <Textarea
              name="message"
              placeholder="Tell us about your learning and development needs..."
              value={formData.message}
              onChange={handleInputChange}
              className="border-0 bg-gray-100 min-h-[80px] sm:min-h-[100px] rounded-[1rem] sm:rounded-[1.5rem] px-3 sm:px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200 resize-none"
            />
          </div>

          <div className="text-xs text-gray-500 leading-relaxed bg-gray-50 p-3 sm:p-4 rounded-[1rem] sm:rounded-[1.5rem]">
          ...
          <Button 
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 sm:py-4 rounded-[1rem] sm:rounded-[1.5rem] font-semibold text-sm sm:text-base shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
          >
            {isSubmitting ? (
              <>
