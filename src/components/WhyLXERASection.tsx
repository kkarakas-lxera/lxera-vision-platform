  ...
  return (
    <>
      ...
      <div className="relative">
        <div className="h-32 bg-gradient-to-b from-smart-beige via-lxera-blue/15 to-lxera-blue/25 relative overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-lxera-blue/12 via-transparent to-business-black/5"></div>
          </div>
          <div className="absolute top-8 left-1/4 w-4 h-4 bg-lxera-blue/30 rounded-full animate-float-gentle blur-sm"></div>
          ...
          <div className="absolute top-12 left-2/3 w-2 h-2 bg-lxera-blue/40 rounded-full animate-float-gentle animate-delay-1000"></div>
        </div>
      </div>

      <section id="platform" className="w-full pt-4 pb-24 px-0 sm:px-6 lg:px-12 relative overflow-hidden bg-gradient-to-br from-lxera-blue/20 via-lxera-blue/12 to-lxera-blue/25">
        <div className="absolute inset-0 bg-gradient-to-tr from-lxera-blue/15 via-transparent to-business-black/5"></div>
        <AnimatedBackground />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            {filteredCapabilities.map((capability, index) => (
              <div
                ...
                className="bg-gradient-to-br from-white/90 via-lxera-blue/15 to-white/80 lxera-shadow text-center group hover:from-white hover:via-lxera-blue/25 hover:to-white/90 hover:shadow-xl transition-all duration-500 lxera-hover animate-fade-in-up"
                style={{
              ...
              >
                <div className="p-6">
                  <div className="mb-4 flex justify-center">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-lxera-blue/30 to-business-black/10 flex items-center justify-center group-hover:scale-110 transition-all duration-300">
                      {capability.icon && (
                        // @ts-ignore
                  ...
                  {capability.tangibleResults && (
                    <div className="overflow-hidden transition-all duration-500 ease-out max-h-0 group-hover:max-h-32 opacity-0 group-hover:opacity-100">
                      <p className="text-sm text-business-black/60 italic border-t border-lxera-blue/20 pt-3 leading-relaxed">
