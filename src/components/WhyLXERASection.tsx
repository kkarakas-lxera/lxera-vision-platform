    ...
    <>
      ...
      <section id="platform" className="w-full pt-4 pb-24 px-0 sm:px-6 lg:px-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-right mb-20 animate-fade-in-up relative">
            <div className="relative z-10">
              ...
              <p className="text-lg sm:text-xl lg:text-xl text-business-black/80 max-w-4xl ml-auto animate-slide-in-right leading-relaxed font-medium" style={{animationDelay: '0.4s'}}>
              ...
              <div className="mt-8 flex justify-end animate-fade-in-scale" style={{animationDelay: '0.6s'}}>
                <div className="relative">
