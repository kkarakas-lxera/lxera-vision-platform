  ...
  return (
    <>
      ...
      <section id="platform" className="w-full py-24 px-6 lg:px-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-gray-50/80"></div>
        <div className="absolute inset-0 bg-gradient-to-tr from-future-green/3 via-transparent to-future-green/8"></div>
        <div className="absolute inset-0 bg-gradient-to-bl from-transparent via-emerald/2 to-transparent"></div>
        
        <AnimatedBackground />
        
        {/* Refined decorative elements */}
        <div className="absolute top-20 left-10 w-40 h-40 rounded-full bg-gradient-to-br from-future-green/8 to-emerald/4 animate-float-gentle blur-xl"></div>
        <div className="absolute bottom-40 right-16 w-48 h-48 rounded-full bg-gradient-to-tl from-future-green/12 to-future-green/3 animate-float-gentle animate-delay-1000 blur-2xl"></div>
        <div className="absolute top-1/2 right-1/4 w-32 h-32 rounded-full bg-gradient-to-r from-emerald/6 to-future-green/4 animate-float-gentle animate-delay-2000 blur-xl"></div>
