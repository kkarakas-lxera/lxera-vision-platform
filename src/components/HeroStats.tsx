        ...
        {stats.map((stat, index) => (
          <Tooltip key={index}>
            <TooltipTrigger asChild>
              <div 
                className="flex flex-col items-center p-6 md:p-8 bg-white/85 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl hover:bg-white/95 hover:scale-105 transition-all duration-300 animate-fade-in-up group relative overflow-hidden focus-within:ring-2 focus-within:ring-future-green/50 border border-future-green/30 cursor-pointer"
                style={{
              ...
              >
                ...
                <stat.icon 
                  className="w-8 h-8 mb-4 group-hover:scale-110 group-hover:animate-pulse transition-all duration-300 relative z-10 text-future-green"
                  aria-hidden="true"
                />
