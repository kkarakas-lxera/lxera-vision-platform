...
const TransformationStartsSection = () => {
  return (
    <section className="w-full py-28 px-6 text-center bg-white relative overflow-hidden">
      {/* Animated background elements with consistent colors */}
      <div className="absolute inset-0 opacity-8">
        <div className="absolute top-10 left-10 w-32 h-32 rounded-full animate-float-gentle bg-gradient-to-br from-future-green/20 to-business-black/5"></div>
        <div className="absolute top-32 right-20 w-20 h-20 rounded-full animate-float-gentle bg-gradient-to-l from-business-black/10 to-future-green/15 animate-delay-1000"></div>
        <div className="absolute bottom-20 left-1/3 w-16 h-16 rounded-full animate-float-gentle bg-gradient-to-r from-future-green/15 to-business-black/8 animate-delay-2000"></div>
      </div>
