  ...
  return (
    <section className="w-full py-20 px-6 text-center bg-gradient-to-b from-smart-beige/80 to-smart-beige/50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-8">
        <div className="absolute top-10 left-10 w-32 h-32 rounded-full animate-float-gentle bg-future-green/20"></div>
        <div className="absolute top-32 right-20 w-20 h-20 rounded-full animate-float-gentle bg-future-green/15 animate-delay-1000"></div>
        <div className="absolute bottom-20 left-1/3 w-16 h-16 rounded-full animate-float-gentle bg-future-green/12 animate-delay-2000"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto animate-fade-in-scale animate-delay-600 border border-white/30 hover:bg-white/70 hover:shadow-xl transition-all duration-500 lxera-hover">
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
        <div className="w-16 h-16 bg-white rounded-full shadow-lg flex items-center justify-center border-2 border-future-green/30 animate-bounce-slow hover:scale-110 transition-transform duration-300 lxera-hover">
