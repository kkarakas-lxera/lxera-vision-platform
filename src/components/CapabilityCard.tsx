    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center backdrop-blur-[2px] p-6 lg:p-8 xl:p-12 min-h-[260px] md:min-h-[240px]">
        ...
        <div className="lg:w-1/3 flex flex-col items-center lg:items-start mb-4 lg:mb-0">
          <div 
            className={`w-20 h-20 md:w-24 md:h-24 ${iconBg} rounded-2xl flex items-center justify-center mb-6 shadow-sm transition-all duration-300
              group-hover:shadow-2xl group-hover:scale-110 group-hover:animate-bounce-slow
            `}
          >
            <Icon className="w-10 h-10 text-white transition-all duration-300 group-hover:scale-110 group-hover:drop-shadow-lg" />
          </div>
