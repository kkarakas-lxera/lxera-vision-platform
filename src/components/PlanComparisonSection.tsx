      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl overflow-hidden border border-gray-200">
          ...
          <div className="grid grid-cols-3 gap-0">
            ...
            <div className="px-6 py-4 text-center bg-lxera-red/20 border-l border-r border-lxera-red">
            ...
            <div className="px-6 py-4 text-center bg-emerald/20 border-l border-r border-emerald">
          ...
          {comparisonFeatures.map((category, categoryIndex) => (
            <div key={categoryIndex}>
              ...
              <div className="grid grid-cols-3 gap-0 border-t border-gray-200">
                ...
                <div className="px-6 py-6 bg-lxera-red/20 border-l border-r border-lxera-red"></div>
                <div className="px-6 py-6 bg-emerald/20 border-l border-r border-emerald"></div>
              </div>
              ...
              {category.features.map((feature, featureIndex) => (
                <div key={featureIndex} className="grid grid-cols-3 gap-0">
                  ...
                  <div className="px-6 py-4 flex items-center justify-center bg-lxera-red/20 border-l border-r border-lxera-red border-t border-gray-100">
                    {feature.core ? (
                  ...
                  <div className="px-6 py-4 flex items-center justify-center bg-emerald/20 border-l border-r border-emerald border-t border-gray-100">
                    {feature.enterprise ? (
                      <Check className="h-5 w-5 text-business-black" />
                    ) : (
                      <X className="h-5 w-5 text-red-500" />
