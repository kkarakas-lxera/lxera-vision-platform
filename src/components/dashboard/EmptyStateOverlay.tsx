...
const EmptyStateOverlay: React.FC<EmptyStateOverlayProps> = ({
  ...
  return (
    <div className="absolute inset-4 sm:inset-6 lg:inset-8 flex items-center justify-center z-10">
      ...
      <div className="relative bg-gradient-to-br from-smart-beige via-future-green/10 to-smart-beige rounded-2xl shadow-2xl border border-gray-200/50 p-6 sm:p-8 lg:p-10 text-center max-w-md w-full overflow-hidden">
