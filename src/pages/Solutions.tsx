...
const Solutions = ({ openDemoModal }: SolutionsProps) => {
  ...
  // Reordered useCases array with correct URLs
  const useCases = [
    {
      id: "ai-personalized-learning",
      url: "/solutions/ai-personalized-learning",
    ...
    },
    {
      ...
      url: "/solutions/workforce-reskilling-upskilling",
    ...
    {
      id: "ai-gamification",
      url: "/solutions/ai-gamification-motivation",
    ...
    {
      id: "ai-mentorship",
      url: "/solutions/ai-mentorship-support",
    ...
    },
    {
      ...
      url: "/solutions/learning-analytics-engagement",
    ...
    },
    {
      ...
      url: "/solutions/citizen-led-innovation",
    ...
    },
    {
      ...
      url: "/solutions/enterprise-innovation-enablement",
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="animate-fade-in-up">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-medium text-business-black mb-4 sm:mb-6 leading-tight px-2 sm:px-0">
              ...
              <span className="bg-gradient-to-r from-future-green to-emerald bg-clip-text text-transparent block sm:inline"> AI-Powered Platform</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-business-black/70 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-2 sm:px-0">
              Discover our integrated suite of AI-driven capabilities that work together to revolutionize learning, 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="md:hidden">
            ...
            <div className="relative">
              ...
              <div ref={scrollContainerRef} className="overflow-x-auto scrollbar-hide -mx-4 px-4" style={{ scrollBehavior: 'smooth' }}>
                <div className="flex gap-4 pb-4" style={{ scrollSnapType: 'x mandatory' }}>
                  {useCases.map((useCase, index) => {
                    ...
                    return (
                      <Card
                        key={useCase.id}
                        className={`group cursor-pointer transition-all duration-300 border-0 ${useCase.bgColor} animate-fade-in-up flex-shrink-0 w-64 ring-2 ring-future-green/20`}
                        style={{ animationDelay: `${index * 80}ms`, scrollSnapAlign: 'center', scrollSnapStop: 'always' }}
                        onTouchStart={() => setActiveCard(useCase.id)}
                        onTouchEnd={() => setActiveCard(null)}
                      >
                        <CardHeader className="pb-3 p-4">
                          <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${useCase.color} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-200`}>
                            <IconComponent className="w-6 h-6 text-white" />
                          </div>
                          <CardTitle className="text-lg font-semibold text-business-black group-hover:text-emerald transition-colors duration-200 leading-tight">
                            {useCase.title}
                          </CardTitle>
                        ...
                        <CardContent className="p-4 pt-0">
                          ...
                          <Button
                            variant="ghost"
                            className={`w-full group-hover:bg-gradient-to-r ${useCase.color} group-hover:text-white transition-all duration-200 font-medium text-sm py-4`}
                            onClick={() => navigate(useCase.url)}
                          >
                            Learn More
                  ...
                  <div
                    ...
                    className={`rounded-full transition-all duration-200 ${
                      index === currentScrollIndex 
                        ? 'w-6 h-2 bg-future-green' 
                        : 'w-2 h-2 bg-business-black/20 hover:bg-business-black/30'
                    }`}
                    onClick={() => {
                      const scrollContainer = scrollContainerRef.current;
                      if (scrollContainer) {
          ...
          <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {useCases.map((useCase, index) => {
              ...
              return (
                <Card
                  key={useCase.id}
                  className={`group cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl border-0 ${useCase.bgColor} animate-fade-in-up ${
                    index === 0 
                      ? 'lg:col-span-2 ring-4 ring-future-green/40 hover:ring-future-green/60' 
                      : 'ring-2 ring-future-green/20'
                  }`}
                ...
                >
                  <CardHeader className="pb-3 sm:pb-4 p-4 sm:p-6">
                    <div className={`w-12 sm:w-14 md:w-16 h-12 sm:h-14 md:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br ${useCase.color} flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-200`}>
                      <IconComponent className="w-6 sm:w-7 md:w-8 h-6 sm:h-7 md:h-8 text-white" />
                    </div>
                    <CardTitle className="text-lg sm:text-xl font-semibold text-business-black group-hover:text-emerald transition-colors duration-200 leading-tight">
                      {useCase.title}
                    </CardTitle>
                  ...
                  <CardContent className="p-4 sm:p-6 pt-0">
                    ...
                    <Button
                      variant="ghost"
                      className={`w-full group-hover:bg-gradient-to-r ${useCase.color} group-hover:text-white transition-all duration-200 font-medium text-sm sm:text-base py-2 sm:py-3`}
                      onClick={() => navigate(useCase.url)}
                    >
                      Learn More
                      <ArrowRight className="w-3 sm:w-4 h-3 sm:h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200" />
                    </Button>
                  </CardContent>
                </Card>
              );
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-orange-400 via-orange-500 to-red-500 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl animate-fade-in-scale">
            ...
            <p className="text-sm sm:text-base md:text-lg text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-2 sm:px-0">
              See how all these integrated capabilities work together to revolutionize learning and innovation 
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0">
              <div className="relative">
                <ProgressiveDemoCapture
                  ...
                  buttonText="See Complete Platform Demo"
                  openDemoModal={openDemoModal}
                  className="bg-white text-orange-600 hover:bg-orange-50 hover:text-orange-700 font-semibold px-6 sm:px-8 md:px-10 py-3 sm:py-4 text-sm sm:text-base rounded-xl sm:rounded-2xl shadow-xl transition-all duration-200 hover:scale-105 hover:shadow-2xl focus:ring-2 focus:ring-white/50 focus:ring-offset-2 border-0 inline-flex items-center justify-center w-full sm:w-auto"
                />
