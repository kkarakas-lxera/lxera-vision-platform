                          ...
                          {hasExplanation && (
                            <Collapsible>
                              <CollapsibleTrigger
                                ...
                                className="ml-2 p-1 hover:bg-future-green/10 rounded-full transition-all duration-200 hover:scale-110"
                                title="Click for details"
                              >
                                <Info className="h-4 w-4 text-business-black/60 hover:text-future-green transition-colors duration-200" />
                              </CollapsibleTrigger>
                              <CollapsibleContent className="mt-2 ml-8 animate-accordion-down">
                                <div className="bg-smart-beige/50 rounded-lg p-3 text-sm text-business-black/70 border-l-2 border-future-green/30 shadow-sm">
